...
public class QueryTemplate extends AbstractSalesForceOperations<Salesforce> implements QueryOperations {
    ...
    public QueryResult query(String query) {
        ...
        URI uri = URIBuilder.fromUri(api.getBaseUrl() + "/v37.0/query").queryParam("q", query).build();
    ...
    public QueryResult nextPage(String pathOrToken) {
        ...
        if (pathOrToken.contains("/")) {
            ...
            return restTemplate.getForObject(api.getBaseUrl() + "/v37.0/query/{token}", QueryResult.class, pathOrToken);
        }
    }
